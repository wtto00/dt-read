<template>
  <text class="tui-icon-class tui-icon" :class="'tui-icon-' + name" :style="styles" @tap="handleClick"></text>
</template>
...
export default {
  ...
  computed: {
    styles() {
      ...
      if (this.size) styl.fontSize = `${this.size}${this.unit || 'px'}`;
      else if (this.unit) styl.fontSize = `${this.size || 32}${this.unit}`;
      if (this.bold) styl.fontWeight = 'bold';
      if (this.margin) styl.margin = this.margin;
      return styl;
    },
  },
  methods: {
