<template>
  <block v-if="position == 'top'">
    <view
      ...
      :class="['tui-' + type, show ? 'tui-top-show' : '']"
    >
      {{ msg }}
    </view>
  </block>
  <block v-else>
    <view
      ...
      :class="['tui-' + type, position == 'center' ? 'tui-centertips' : 'tui-bottomtips', show ? 'tui-toast-show' : '']"
    >
      <view class="tui-tips-content" :style="{ backgroundColor: backgroundColor, color: color, fontSize: size + 'rpx' }">
        {{ msg }}
      </view>
    </view>
  </block>
